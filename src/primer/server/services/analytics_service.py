...
from primer.server.services.analytics_bottlenecks import (
    get_bottleneck_analytics as _get_bottleneck_analytics,
)
...
def get_bottleneck_analytics(
    ...
    return _get_bottleneck_analytics(
        db,
        team_id=team_id,
        engineer_id=engineer_id,
        start_date=start_date,
        end_date=end_date,
        project_name=project_name,
        cache_getter=get_cached_json,
        cache_setter=set_cached_json,
    )
