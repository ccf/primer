...
- [x] [P1] Cursor native telemetry enrichment for approvals, change shape, and context-usage signals
- [x] [P1] Cursor reliable token and model-usage extraction once source telemetry is trustworthy
...
- [x] [P1] Time-lost estimation per friction type, engineer, and project
- [x] [P1] Toolchain reliability analytics for MCP servers, built-in tools, and external services
...
- [x] [P1] Model selection coach for cost-appropriate model choice by task
- [x] [P1] Personal impact review that combines trajectory, quality, cost, and workflow maturity
...
- [x] [P1] Project-level agent mix comparison, including Cursor sessions alongside CLI agents
...
- [x] [P1] Analytics performance work for large orgs and concurrent dashboard usage
